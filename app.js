...
app.use(cors({
  "origin": ["http://localhost:8080","http://localhost:5000","http://127.0.0.1:8054","http://localhost:8081"],  //允许所有前端域名
...
app.use('/api/newlist',require('./routes/api/newlist'))
app.use('/api/photoshare',require('./routes/api/photoshare'))
app.use('/api/shoplist',require('./routes/api/shoplist'))
